...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_2.addAction(self.action_help_2)
        self.menu_2.addAction(self.action_about_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_help_2.setText(_translate("MainWindow", "使用说明"))
        self.action_about_2.setText(_translate("MainWindow", "关于"))
